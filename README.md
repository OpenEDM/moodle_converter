...
1. Лог-файл Moodle
    ...
    Файл имеет формат CSV (с названиями колонок), разделитель — «;». Колонки должны иметь названия:
    * Время
...
1. Файлы ответов студентов
    ...
    Файл имеет CSV (с названиями колонок), разделитель — «,». Колонки должны иметь названия:
    * Фамилия
    * Имя
...
1. Запустить парсер
    ...
    * Файлы `../data/Test1.csv`, `../data/Test2.csv` — файлы ответов студентов
